Reference filename mappings:

ref00.txt -> PQ02_Elgar_note.txt
ref01.txt -> PQ03_Farranc_note.txt
ref02.txt -> PS01_Beethoven_note.txt
ref03.txt -> PS02_Chopin_note.txt
ref04.txt -> PS03_Mozart_note.txt
ref05.txt -> SQ01_Beethoven_note.txt
ref06.txt -> SQ02_Janacek_note.txt
ref07.txt -> SQ03_Schubert_note.txt
ref08.txt -> VS01_Schumann_note.txt
ref09.txt -> VS04_Franck_note.txt

Estimate filename mappings:

est0* -> BW2

Algorithm mappings:

Submission code     Submission name     Contributors
